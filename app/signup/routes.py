...
def signup():
    ...
    database.users_table.UsersTable().insert_user(email=userId, password=password, family_id=family_id, family_role=family_role,
...
def modify_user(user_id: str):
    ...
    database.users_table.UsersTable().update_user(email=user_id, password=password, firstname=firstname, lastname=lastname)
